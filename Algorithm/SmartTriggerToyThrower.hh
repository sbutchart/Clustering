...
class LikelihoodTriggerToyThrow {
...
private:
  ...
  std::piecewise_constant_distribution<double> background_distrib_;
  std::poisson_distribution<int> signal_number_;
  std::poisson_distribution<int> background_number_;
  size_t ntoys_;
};


class SmartTriggerToyThrowerERec {
public:
  SmartTriggerToyThrowerERec(const std::string f):
    fSmTrig(""),
    fToyThrown(false),
    fNToys(0),
    fSeed(5056),
...
class ThrowTriggerToyLikelihood {
public:
  ThrowTriggerToyLikelihood():
    fSmTrig(""),
    fToyThrown(false),
    fNToys(0),
    fSeed(5056),

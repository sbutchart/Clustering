...
#include "TriggerDecision/TriggerSensitivityCalculatorTA.hh"
...
int main(int argc, char** argv) {
  ...
  std::cout << "Start TSC" << std::endl;
  TriggerSensitivityCalculator tsc(nEvent, 10, nToy, nThread,
                                   InputSignalFileName,

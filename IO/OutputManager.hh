...
public:
  ...
  void Initialise() {
    ...
    fTrees["WireHitClusters"]->Branch("pur_Ar39Lar" ,   &pur_Ar39Lar ,   "pur_Ar39Lar/D"   );
    fTrees["WireHitClusters"]->Branch("pur_Ar42Lar" ,   &pur_Ar42Lar ,   "pur_Ar42Lar/D"   );
    fTrees["WireHitClusters"]->Branch("pur_K42Lar"  ,   &pur_K42Lar  ,   "pur_K42Lar/D"    );
    fTrees["WireHitClusters"]->Branch("pur_Kr85Lar" ,   &pur_Kr85Lar ,   "pur_Kr85Lar/D"   );
    fTrees["WireHitClusters"]->Branch("pur_Rn222Lar",   &pur_Rn222Lar,   "pur_Rn222Lar/D"  );
    fTrees["WireHitClusters"]->Branch("pur_Po218Lar",   &pur_Po218Lar,   "pur_Po218Lar/D"  );
    fTrees["WireHitClusters"]->Branch("pur_Pb214Lar",   &pur_Pb214Lar,   "pur_Pb214Lar/D"  );
    fTrees["WireHitClusters"]->Branch("pur_Bi214Lar",   &pur_Bi214Lar,   "pur_Bi214Lar/D"  );
    fTrees["WireHitClusters"]->Branch("pur_Pb210Lar",   &pur_Pb210Lar,   "pur_Pb210Lar/D"  );
    ...
    fTrees["WireHitClusters"]->Branch("pur_Bi210CPA",   &pur_Bi210CPA,   "pur_Bi210CPA/D"  );
    fTrees["WireHitClusters"]->Branch("pur_Co60APA" ,   &pur_Co60APA ,   "pur_Co60APA/D"   );
  ...
  void FillClusterInfo(WireCluster* clust) {
    ...
    pur_Ar39Lar    = clust->GetPurity(kAr39_Lar );
    pur_Ar42Lar    = clust->GetPurity(kAr42_Lar );
    pur_K42Lar     = clust->GetPurity(kK42_Lar  );
    pur_Kr85Lar    = clust->GetPurity(kKr85_Lar );
    pur_Rn222Lar   = clust->GetPurity(kRn222_Lar);
    pur_Po218Lar   = clust->GetPurity(kPo218_Lar);
    pur_Pb214Lar   = clust->GetPurity(kPb214_Lar);
    pur_Bi214Lar   = clust->GetPurity(kBi214_Lar);
    pur_Pb210Lar   = clust->GetPurity(kPb210_Lar);
    pur_K40CPA     = clust->GetPurity(kK40_CPA  );
    pur_Ar42CPA    = clust->GetPurity(kAr42_CPA );
    pur_U238CPA    = clust->GetPurity(kU238_CPA );
    pur_Po218CPA   = clust->GetPurity(kPo218_CPA);
    pur_Pb214CPA   = clust->GetPurity(kPb214_CPA);
    pur_Bi214CPA   = clust->GetPurity(kBi214_CPA);
    pur_Pb210CPA   = clust->GetPurity(kPb210_CPA);
    pur_Bi210CPA   = clust->GetPurity(kBi210_CPA);
    pur_Co60APA    = clust->GetPurity(kCo60_APA );
